...
$this->title='EJINSIGHT - ejinsight.com';?>
         ...
         <section id="content" class="home" >
            ...
            <div class="left_col feature_window" >
                ...
                <center><a href="/eji/category/startups"><img src="<?php echo Yii::$app->params['staticUrl'];?>rh_banner/startups_338x80.png"></a></center>
                </div>
          ...
          <div class="w1200" >
              <div class="left_col" >
						...
						<?php  
						echo $this->render('home_left_widgets',array('label'=>'LIFESTYLE','link'=>'category/living','widget'=>$widget5)); 
						...
						//echo $this->render('home_left_widgets',array('label'=>'HONG KONG','link'=>'listing?category=hongkong','widget'=>$widget3));
						...
						?>   
						  ...
						  <div class="right_col">
                              ...
                              <div class="r_lrec"><?php include(dirname(__FILE__).'/../banner/ad_LargeRec2_setting.php'); ?></div>  
                              <!--sidebar_member-->                              
