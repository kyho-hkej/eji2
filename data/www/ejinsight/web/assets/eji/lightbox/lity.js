...
(function(window, factory) {
    ...
    function imageHandler(target, instance) {
        var desc = (instance.opener() && instance.opener().data('lity-desc')) || 'Image with no description';
               var img = $('<img src="' + target + '" alt="' + desc + '"/> <div>"' + desc + '" </div>');
        var deferred = _deferred();
        var failed = function() {
    ...
    function iframeHandler(target, instance) {
         var desc2 = (instance.opener() && instance.opener().data('lity-desc')) || '';
          
        
        return '<h1 class="video_title">' + desc2 + '</h1><div class="lity-iframe-container"><iframe frameborder="0" allowfullscreen src="' + target + '"/></div>';
    }
    ...
    function Lity(target, options, opener, activeElement) {
        ...
        self.close = function() {
            ...
            content.trigger('lity:close', [self]);
             ...
             $('body').removeClass('lity-features');
        ...
        element
            ...
            .on('click', '[data-lity-close]', function(e) {
                if ($(e.target).is('[data-lity-close]')) {
                    self.close();
					 document.getElementById("fvideo").muted=true;  
                }
            })
