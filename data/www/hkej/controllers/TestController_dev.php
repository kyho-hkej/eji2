 ...
 public function actionCreatearticle()
    {
     ...
     // \Yii::$app->response->format = \yii\web\Response::FORMAT_JSON;
        ...
        $token = "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..2_-3q9yV1pM8ZIJ5bU17ZZIvSMxKOLwZiynR_axxySE";
        ...
        $folder_path = Yii::getAlias('@app').'/assets/bd/output/20231010/*.json';
...
//echo $file." - ";
        ...
        $fp = fopen(Yii::getAlias('@app').'/assets/bd/output/20231010/log/'.'res_log.txt', 'a') or die("Unable to open file!");
        $result="\n".$logResult;
        fwrite($fp, $result);
        fclose($fp);
        //move_uploaded_file($folder_path, Yii::getAlias('@app').'/assets/bd/output/20231010/archive/');
        rename($file, Yii::getAlias('@app').'/assets/bd/output/20231010/archive/'.basename($file));
        }
  ...
  public function actionCreatetag()
    ...
    public function actionGenarticlejsonfile(){
      ...
      $path = Yii::getAlias('@app').'/assets/bd/output/20231010/';
      ...
      $sqlData=" SELECT a.ID, a.post_title as title, 
        ...
        and  (a.ID >=".$start_id." and  a.ID <= ".$end_id.") and a.ID != '3038' order by a.ID desc";
        ...
        foreach ($rows as $r) {
          ...
          if ($r['author']!='user') {
              ...
              $tmp['language'] = 'zh-cht';
              $tmp['articleUrl'] = $this->chineseSymbols($r['articleUrl']).'_V5';
...
public function actionFiletest(){
    ...
    public function chineseSymbols($str)
    {
